...
layout(location = 2) in vec4 inColor;     // VisualRect.color[4] // Binding at Vertex Buffer 1
layout(location = 3) in vec2 inPos;       // VisualRect.pos[2]
layout(location = 4) in vec2 inSize;      // VisualRect.size[2]
